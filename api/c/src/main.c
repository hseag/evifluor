...
void help(int argcCmd, char **argvCmd)
{
	...
	else
	{
		if(argcCmd == 2)
		{
            ...
            {
                fprintf_s(stdout, "Usage: evifluor run [OPTIONS] init NR_STD_LOW NR_STD_HIGH CONCENTRATION [--no-air] [--kit=NAME] [--k1=VALUE] [--k2=VALUE] [--k3=VALUE] [--lookup_table=FILE] [--settling-time=SECONDS]\n");
                ...
                fprintf_s(stdout, "  --k1=VALUE             : only for 'run init'; optional kit parameter k1\n");
                fprintf_s(stdout, "  --k2=VALUE             : only for 'run init'; optional kit parameter k2\n");
                fprintf_s(stdout, "  --k3=VALUE             : only for 'run init'; optional kit parameter k3\n");
                fprintf_s(stdout, "  --lookup_table=FILE    : only for 'run init'; optional lookup-table CSV or JSON file\n");
