...
This documentation describes Python package version `0.12.0`.
...
```bash
python -m pip install "hse-evifluor[rest] @ https://hseag.github.io/evifluor/pre-release/api/python/dist/hse_evifluor-0.12.0-py3-none-any.whl"
```
